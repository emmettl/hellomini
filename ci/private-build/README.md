...
The workflow requires macOS 26+, Apple silicon, and Xcode 26.6 at `/Applications/Xcode.app`. It runs all checks including real Metal rendering, makes a release app bundle, verifies its ad-hoc signature, and uploads a ZIP for 14 days. It does not install or launch the build, change the running Hello Mini app, or perform notarization.
